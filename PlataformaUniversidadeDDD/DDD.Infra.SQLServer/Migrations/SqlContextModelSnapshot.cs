...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDD.Domain.TiContext.Chamado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DDD.Domain.TiContext.Chamador", b =>
                {
                    b.HasBaseType("DDD.Domain.UserManagementContext.User");

                    b.ToTable("Chamador", (string)null);
                });

            modelBuilder.Entity("DDD.Domain.TiContext.Tecnico", b =>
                {
                    b.HasBaseType("DDD.Domain.UserManagementContext.User");
            ...
            modelBuilder.Entity("DDD.Domain.TiContext.Chamado", b =>
                {
                    b.HasOne("DDD.Domain.TiContext.Chamador", "Chamador")
                        .WithMany("Chamados")
                        .HasForeignKey("IdChamador")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
